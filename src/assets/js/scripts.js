...
function getCredential() {
    ...
    // const data = { 'authcode': authCode, 'authcredential': btoa("teachermodule:pin"),'redirectUrl': 'https://pgi.udiseplus.gov.in/teacher/teacher/profile' } --Not in use
    // const data = { 'authcode': authCode, 'authcredential': btoa("teachermodule:pin"),'redirectUrl': 'https://kvsdemo.udiseplus.gov.in/teacher/teacher/profile' } --Not in use
...
function getKey() {
    ...
    $.ajax({
        ...
        // url: "http://10.25.26.251:8020/api/login/getKey",
