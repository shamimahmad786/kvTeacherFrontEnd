...
export const environment = {
  production: false,
   //Local
   LOGIN_URL_JWT:'http://10.25.26.251:8020/api/login/',
   BASE_URL_DATA: 'http://10.25.26.10:8020/api/teacher/',
   udiseApi:'https://demo.udiseplus.gov.in/api-v1/public/getSchoolMaster/',
   auth_service:'http://' + "10.25.26.251:8020/meuser"+'/api/userCradential',
   BASE_URL_DATA_TEACHER_TRANSFER:'http://10.25.26.251:8020/api/transprofile/',
   BASE_URL_DATA_TEACHER: 'http://10.25.26.251:8020/api/teacher/',
   BASE_URL_DATA_MASTER: 'http://10.25.26.251:8020/api/master/',
   BASE_URL_DATA_QUESTION: 'http://10.25.26.251:8020/api/question/',
   BASE_URL_DATA_SURVEY: 'http://10.25.26.251:8020/api/survey/',
   BASE_URL_DATA_EXPERIENCE: 'http://10.25.26.251:8020/api/experience/',
   BASE_URL_DATA_PROMOTION: 'http://10.25.26.251:8020/api/promotion/',
   BASE_URL_DATA_QUALIFICATION: 'http://10.25.26.251:8020/api/qualification/',
   BASE_URL_DATA_AWARDS: 'http://10.25.26.251:8020/api/awards/',
   BASE_URL_DATA_TRANSFER: 'http://10.25.26.251:8020/api/transfer/',
   BASE_URL_DATA_TEACHER_TRANSFER_V2: 'http://10.25.26.251:8020/api/teacher/transfer/',
   BASE_URL_DATA_TRANSFER_PROCESS: 'http://10.25.26.251:8020/api/transferprocess/',
   BASE_URL_REPORT:'http://10.25.26.251:8020/api/kvsreport/',
   ...
   BASE_URL_DATA_MASTER1:'http://10.25.26.251:8020/unee-api/v1/master/',
